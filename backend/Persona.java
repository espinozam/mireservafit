...
public abstract class Persona {
    ...
    public Persona(String dni, String nombre, String apellido1, String apellido2, int edad, String email, String contrasena) {
        this.setDni(dni);
    ...
    public void setContrasena(String contrasena) {
        Scanner teclado = new Scanner(System.in);
        while (contrasena == null || contrasena.length() < 8) {
    ...
    // El método getContrasena devuelve la contraseña original decodificada
